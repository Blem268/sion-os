...
console.log('%c SION OS v0.5.0 ', 'background:#00ff88;color:#080808;font-weight:bold;font-family:monospace;padding:2px 8px;');
console.log('%c Sprint 4 — Younity + Blueport online. ', 'color:#666;font-family:monospace;');
