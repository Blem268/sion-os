...
console.log('%c SION OS v0.4.0 ', 'background:#00ff88;color:#080808;font-weight:bold;font-family:monospace;padding:2px 8px;');
console.log('%c Sprint 3 — Blem Tuned online. ', 'color:#666;font-family:monospace;');
